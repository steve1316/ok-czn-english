...
UPSTREAM_NAMES = {
    "utils": (
        "_current_equipment_for_slot", "_equipment_info", "_equipment_priority", "_equipment_quality_at", "_equipment_state", "_rgb_is_close",
        "_find_member_level_tags", "_find_target_member_index",
